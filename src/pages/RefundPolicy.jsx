  ...
  return (
    <div className="min-h-screen bg-(--color-bg) py-12 px-4 sm:px-8 lg:px-16">
      <header className="mx-auto max-w-4xl">
        <div className="overflow-hidden rounded-2xl bg-linear-to-r from-orange-50 via-white to-slate-50 p-6 shadow-sm">
      ...
      <main className="mx-auto mt-8 max-w-4xl">
        <article className="space-y-8">
          ...
          <section className="overflow-hidden rounded-xl bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-slate-600">
              We offer a 7-day money-back guarantee for all new enrollments. If you are not fully satisfied after your first paid session, simply contact us at <strong>support@getmetutor.online</strong> within 7 days of your first session to request a full refund for any unused sessions.
            </p>
            <p className="mt-3 text-slate-600">
          ...
          <section className="overflow-hidden rounded-xl bg-linear-to-r from-orange-50 to-slate-50 p-6 shadow-sm">
